...
## Reforma visual 1.0.127
- GitHub passou de drawer lateral para workspace centralizado e responsivo.
- Integrações migrou cabeçalho e modais para o Design System e centralizou também o diagnóstico geral.
- Cloudflare migrou Explorer/ferramentas para `DSModal`; o laranja fica restrito à identidade do provedor.
- `--adm-subtle` e `--adm-overlay` foram adicionados aos quatro temas e aos fallbacks globais.
- Projetos/Deploys, Monitor e Assistente tiveram cores semânticas fixas trocadas por tokens de tema.
- `check:themes` valida 19 tokens em Claro, Escuro, Oceano e Rosa e pontos básicos de responsividade.
