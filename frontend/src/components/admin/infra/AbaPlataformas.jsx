...
export default function AbaPlataformas(){
  ...
  return <div className="projects-center">
    <section className="pc-hero">
      ...
      <div className="pc-hero-actions"><button onClick={()=>load()}><AdminIcon name="refresh" size={14}/> Sincronizar</button><button className="primary" onClick={()=>setConfig(true)}><AdminIcon name="gear" size={14}/> Definir Painel</button></div>
    </section>
