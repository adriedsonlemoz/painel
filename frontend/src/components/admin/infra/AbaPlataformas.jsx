...
const traduzStatus=value=>{
  const s=String(value||'').trim()
  if(!s)return 'status não consultado'
  if(/all systems operational|all systems are operational/i.test(s))return 'Todos os sistemas operacionais'
  if(/operational/i.test(s))return 'Operacional'
  if(/degraded performance/i.test(s))return 'Desempenho degradado'
  if(/partial outage/i.test(s))return 'Indisponibilidade parcial'
  if(/major outage/i.test(s))return 'Indisponibilidade geral'
  if(/maintenance/i.test(s))return 'Em manutenção'
  return s
}
...
export default function AbaPlataformas(){
  ...
  return <div className="projects-center">
    ...
    <section className="pc-provider-strip">
      <div><ProviderTag type="vercel"/><span>{data.provedores?.vercel?.utilizavel?plural(data.provedores.vercel.projetos?.length||0,'projeto','projetos'):'não conectada'}</span><em className={status?.vercel?.indicador==='operational'?'ok':''}>{traduzStatus(status?.vercel?.descricao)}</em></div>
      <div><ProviderTag type="render"/><span>{data.provedores?.render?.utilizavel?plural(data.provedores.render.servicos?.length||0,'serviço','serviços'):'não conectada'}</span><em className={status?.render?.indicador==='operational'?'ok':''}>{traduzStatus(status?.render?.descricao)}</em></div>
    ...
    <section className="pc-section"><header><div><small>OUTROS PROJETOS</small><h3>{filter==='todos'?'Projetos monitorados':'Resultado'}</h3></div><span>{plural(others.length,'projeto','projetos')}</span></header>
    ...
    <style>{`
      .projects-center{display:grid;gap:14px;min-width:0}.pc-loading{min-height:180px;display:flex;align-items:center;justify-content:center;gap:9px;color:var(--adm-muted);font-size:12px}.pc-hero{display:flex;justify-content:space-between;gap:18px;align-items:flex-end;padding:20px;border:1px solid var(--adm-border);border-radius:18px;background:linear-gradient(135deg,color-mix(in srgb,var(--adm-accent) 7%,var(--adm-surface)),var(--adm-surface))}.pc-hero>div:first-child{max-width:700px}.pc-hero span,.pc-section header small{font-size:12px;font-weight:900;letter-spacing:.14em;color:var(--adm-accent)}.pc-hero h2{margin:5px 0 5px;font-size:25px;color:var(--adm-text)}.pc-hero p{margin:0;font-size:11px;line-height:1.55;color:var(--adm-muted)}.pc-hero-actions{display:flex;gap:8px;flex-wrap:wrap}.pc-hero-actions button,.pc-hero-actions .pc-action-link,.pc-modal-actions button{display:inline-flex;align-items:center;justify-content:center;gap:6px;padding:9px 11px;border:1px solid var(--adm-border);border-radius:9px;background:var(--adm-surface2);color:var(--adm-text);font-size:12px;font-weight:800;cursor:pointer;text-decoration:none}.pc-hero-actions .primary,.pc-modal-actions .primary{background:var(--adm-accent);border-color:var(--adm-accent);color:#fff}.pc-provider-warning{display:grid;grid-template-columns:auto minmax(0,1fr) auto;gap:10px;align-items:center;padding:11px 12px;border:1px solid #d9770644;border-radius:12px;background:#d9770609;color:#d97706}.pc-provider-warning>div{display:grid;gap:2px}.pc-provider-warning b{font-size:11px}.pc-provider-warning span{font-size:12px;color:var(--adm-muted);overflow-wrap:anywhere}.pc-provider-warning a{font-size:12px;color:var(--adm-accent);text-decoration:none}.pc-kpis{display:grid;grid-template-columns:repeat(4,minmax(0,1fr));gap:8px}.pc-kpis>div{display:grid;gap:1px;padding:12px 13px;border:1px solid var(--adm-border);border-radius:13px;background:var(--adm-surface)}.pc-kpis b{font-size:21px;color:var(--adm-text)}.pc-kpis small{font-size:12px;color:var(--adm-muted)}.pc-kpis .attention b{color:#d97706}.pc-provider-strip{display:grid;grid-template-columns:1fr 1fr auto;gap:8px;align-items:center}.pc-provider-strip>div{display:flex;align-items:center;gap:8px;padding:8px 10px;border:1px solid var(--adm-border);border-radius:11px;background:var(--adm-surface)}.pc-provider-strip span{font-size:12px;color:var(--adm-text)}.pc-provider-strip em{margin-left:auto;font-size:11px;color:var(--adm-muted);font-style:normal;white-space:nowrap}.pc-provider-strip em.ok{color:#16a34a}.pc-provider-strip>a{font-size:12px;color:var(--adm-accent);text-decoration:none}.pc-provider{display:inline-flex;align-items:center;padding:4px 6px;border-radius:7px;font-size:11px;font-weight:900;border:1px solid var(--adm-border);white-space:nowrap}.pc-provider.vercel{background:#111;color:#fff}.pc-provider.render{background:#7c3aed10;color:#7c3aed;border-color:#7c3aed33}.pc-filters{display:flex;gap:6px;overflow:auto;padding-bottom:1px}.pc-filters button{white-space:nowrap;border:1px solid var(--adm-border);background:var(--adm-surface);color:var(--adm-muted);border-radius:999px;padding:6px 10px;font-size:12px;font-weight:800}.pc-filters button.active{background:var(--adm-accent);border-color:var(--adm-accent);color:#fff}.pc-section{display:grid;gap:10px}.pc-section>header{display:flex;justify-content:space-between;gap:10px;align-items:flex-end}.pc-section header h3{margin:3px 0 0;font-size:16px;color:var(--adm-text)}.pc-section header>span,.pc-section header>a{font-size:12px;color:var(--adm-muted);text-decoration:none}.pc-grid{display:grid;grid-template-columns:repeat(3,minmax(0,1fr));gap:9px}.pc-card{min-width:0;display:grid;gap:11px;padding:13px;border:1px solid var(--adm-border);border-radius:15px;background:var(--adm-surface);color:var(--adm-text);text-decoration:none;box-shadow:var(--adm-shadow-sm);transition:.14s}.pc-card:hover{transform:translateY(-1px);border-color:color-mix(in srgb,var(--adm-accent) 35%,var(--adm-border))}.pc-card.featured{padding:15px;border-color:color-mix(in srgb,var(--adm-accent) 30%,var(--adm-border));background:linear-gradient(135deg,color-mix(in srgb,var(--adm-accent) 4%,var(--adm-surface)),var(--adm-surface))}.pc-card-top{display:flex;gap:9px;align-items:flex-start}.pc-project-icon{width:35px;height:35px;border:1px solid var(--adm-border);border-radius:10px;background:var(--adm-surface2);display:grid;place-items:center;color:var(--adm-accent);flex:0 0 auto}.pc-title{min-width:0;display:flex;justify-content:space-between;gap:8px;align-items:flex-start;flex:1}.pc-title>div{min-width:0}.pc-title h3{font-size:13px;margin:1px 0 0;overflow:hidden;text-overflow:ellipsis;white-space:nowrap}.pc-special{display:block;font-size:11px!important;color:var(--adm-accent)!important;letter-spacing:.12em}.pc-status{display:inline-flex;align-items:center;gap:4px;padding:4px 6px;border-radius:999px;border:1px solid var(--adm-border);font-size:11px;font-weight:850;white-space:nowrap}.pc-status i{width:5px;height:5px;border-radius:50%;background:currentColor}.pc-status.ok{color:#16a34a;border-color:#16a34a33;background:#16a34a08}.pc-status.info{color:#2563eb;border-color:#2563eb33;background:#2563eb08}.pc-status.warn{color:#d97706;border-color:#d9770633;background:#d9770608}.pc-status.bad{color:#dc2626;border-color:#dc262633;background:#dc262608}.pc-status.muted{color:var(--adm-muted)}.pc-tags{display:flex;gap:5px;flex-wrap:wrap;align-items:center}.pc-repo{min-width:0;max-width:100%;font-size:11px;color:var(--adm-muted);overflow:hidden;text-overflow:ellipsis;white-space:nowrap}.pc-deploy{display:grid;gap:3px;padding:9px 10px;border:1px solid var(--adm-border);border-radius:10px;background:var(--adm-surface2)}.pc-deploy small{font-size:11px;font-weight:900;letter-spacing:.1em;color:var(--adm-muted)}.pc-deploy b{font-size:12px;overflow:hidden;text-overflow:ellipsis;white-space:nowrap}.pc-deploy span{font-size:11px;color:var(--adm-muted)}.pc-card footer{display:flex;justify-content:space-between;gap:8px;align-items:center}.pc-card footer>span{font-size:11px;color:var(--adm-muted)}.pc-card footer strong{display:flex;align-items:center;gap:3px;font-size:12px;color:var(--adm-accent)}.pc-empty{min-height:120px;border:1px dashed var(--adm-border);border-radius:14px;display:grid;place-items:center;align-content:center;gap:5px;text-align:center;color:var(--adm-muted);padding:16px}.pc-empty b{font-size:11px;color:var(--adm-text)}.pc-empty span{font-size:12px;max-width:440px;line-height:1.45}.pc-problems{display:grid;gap:6px}.pc-problems>a{display:grid;grid-template-columns:22px minmax(0,1fr) auto;gap:8px;align-items:center;padding:9px 10px;border:1px solid var(--adm-border);border-radius:10px;background:var(--adm-surface);text-decoration:none;color:var(--adm-text)}.pc-problems>a>span{width:22px;height:22px;border-radius:7px;background:#dc262610;color:#dc2626;display:grid;place-items:center;font-weight:900}.pc-problems>a>div{min-width:0;display:grid;gap:2px}.pc-problems b{font-size:12px}.pc-problems small{font-size:11px;color:var(--adm-muted);overflow:hidden;text-overflow:ellipsis;white-space:nowrap}.pc-problems strong{font-size:11px;color:var(--adm-accent)}.pc-clear{display:flex;align-items:center;gap:9px;padding:11px;border:1px solid #16a34a33;border-radius:11px;background:#16a34a08;color:#16a34a}.pc-clear>div{display:grid;gap:2px}.pc-clear b{font-size:12px;color:var(--adm-text)}.pc-clear span{font-size:11px;color:var(--adm-muted)}.pc-overlay{position:fixed;inset:0;z-index:1500;background:rgba(15,23,42,.46);backdrop-filter:blur(3px);display:grid;place-items:center;padding:12px}.pc-modal{width:min(100%,520px);max-height:calc(100dvh - 24px);overflow:auto;padding:17px;border:1px solid var(--adm-border);border-radius:17px;background:var(--adm-surface);box-shadow:0 22px 70px rgba(0,0,0,.26)}.pc-modal header{display:flex;justify-content:space-between;align-items:flex-start;gap:10px}.pc-modal header small{font-size:11px;font-weight:900;letter-spacing:.13em;color:var(--adm-accent)}.pc-modal h2{font-size:19px;margin:3px 0}.pc-modal header button{width:30px;height:30px;border:1px solid var(--adm-border);border-radius:8px;background:var(--adm-surface2);color:var(--adm-text);font-size:18px}.pc-modal-copy{font-size:12px;line-height:1.5;color:var(--adm-muted)}.pc-modal label{display:block;margin-top:10px;font-size:12px;font-weight:800}.pc-modal select,.pc-modal input{display:block;width:100%;box-sizing:border-box;margin-top:5px;padding:9px 10px;border:1px solid var(--adm-border);border-radius:9px;background:var(--adm-bg);color:var(--adm-text)}.pc-modal label small{display:block;margin-top:4px;color:var(--adm-muted);font-weight:400;font-size:11px}.pc-modal-actions{display:flex;justify-content:flex-end;gap:7px;margin-top:14px}
