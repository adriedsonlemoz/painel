  ...
  return (
    <div className="news-image-upload">
      ...
      <style>{`
        ...
        .news-image-preview-bar{display:flex;align-items:center;justify-content:space-between;gap:10px;padding:9px 10px}.news-image-meta{min-width:0;display:flex;flex-direction:column;gap:2px;color:var(--adm-muted)}.news-image-meta span{font-size:11px;font-weight:700;color:var(--adm-accent);display:flex;gap:5px;align-items:center}.news-image-meta small{font-size:12px;white-space:nowrap;overflow:hidden;text-overflow:ellipsis}.news-image-actions{display:flex;gap:6px;flex-shrink:0}
