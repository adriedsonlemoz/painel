...
.cd-head{display:flex;justify-content:space-between;gap:18px;align-items:flex-end;padding:4px 1px 10px}.cd-eyebrow{font:800 10px/1.2 var(--adm-mono);letter-spacing:.18em;color:var(--accent);text-transform:uppercase}.cd-head h1{font-size:clamp(25px,5vw,39px);line-height:1.03;letter-spacing:-.045em;margin:7px 0 5px}.cd-head p{margin:0;color:var(--muted);font-size:13px}.cd-live{display:flex;align-items:center;gap:7px;white-space:nowrap;font-size:10px;font-weight:850;letter-spacing:.08em}.cd-dot{width:7px;height:7px;border-radius:50%;background:var(--adm-success,#22c55e);box-shadow:0 0 0 4px color-mix(in srgb,var(--adm-success,#22c55e) 12%,transparent)}.cd-dot.warn{background:var(--adm-red);box-shadow:0 0 0 4px color-mix(in srgb,var(--adm-red) 12%,transparent)}
.cd-panel{--rail:var(--adm-accent);background:var(--panel);border:1px solid var(--line);border-radius:var(--adm-radius);overflow:hidden;position:relative;box-shadow:var(--adm-shadow)}.cd-panel:before{content:"";position:absolute;inset:0 auto 0 0;width:2px;background:var(--rail);opacity:.7}.cd-pad{padding:18px}.cd-section-head{display:flex;align-items:flex-start;justify-content:space-between;gap:12px;margin-bottom:16px}.cd-label{font:800 9px/1.2 var(--adm-mono);letter-spacing:.14em;color:var(--muted);text-transform:uppercase}.cd-title{font-size:18px;font-weight:800;letter-spacing:-.025em;margin-top:4px}.cd-link{color:var(--accent);font-size:10px;font-weight:800;text-decoration:none;letter-spacing:.05em;text-transform:uppercase;white-space:nowrap}.cd-hero{background:radial-gradient(circle at 90% 10%,color-mix(in srgb,var(--accent) 10%,transparent),transparent 32%),var(--panel)}.cd-status{display:inline-flex;align-items:center;gap:6px;border:1px solid color-mix(in srgb,var(--adm-success,#22c55e) 35%,var(--line));border-radius:999px;padding:5px 8px;font-size:9px;font-weight:850;color:var(--adm-success,#22c55e)}
.cd-feature{display:grid;grid-template-columns:minmax(0,1fr) auto;gap:12px;align-items:end;padding-top:14px}.cd-feature h2{font-size:clamp(19px,4vw,29px);margin:0 0 5px;letter-spacing:-.035em}.cd-feature p{margin:0;color:var(--muted);font-size:12px;max-width:620px}.cd-actions{display:flex;gap:7px;flex-wrap:wrap;justify-content:flex-end}.cd-btn{border:1px solid var(--line);background:var(--adm-surface2);color:var(--text);text-decoration:none;border-radius:9px;padding:9px 11px;font-size:10px;font-weight:800;white-space:nowrap}.cd-btn.primary{background:var(--accent);border-color:var(--accent);color:#fff}
.cd-project-summary{display:grid;grid-template-columns:repeat(2,minmax(0,1fr)) auto;gap:8px;align-items:stretch;margin-bottom:12px}.cd-project-metric{border:1px solid var(--line);border-radius:10px;background:var(--adm-surface2);padding:10px 11px}.cd-project-metric span{display:block;font:800 8px/1.2 var(--adm-mono);letter-spacing:.08em;color:var(--muted);text-transform:uppercase}.cd-project-metric b{display:block;margin-top:4px;font-size:18px;letter-spacing:-.03em}.cd-project-jump{display:flex;align-items:center;justify-content:center;gap:6px;border:1px solid color-mix(in srgb,var(--accent) 30%,var(--line));border-radius:10px;padding:9px 11px;text-decoration:none;color:var(--accent);font-size:10px;font-weight:850;background:color-mix(in srgb,var(--accent) 5%,var(--panel));white-space:nowrap}.cd-project-row,.cd-activity-row,.cd-alert-row,.cd-news-row{display:grid;grid-template-columns:auto minmax(0,1fr) auto;gap:10px;align-items:center;padding:11px 0;border-top:1px solid var(--line)}.cd-project-row:first-of-type,.cd-activity-row:first-of-type,.cd-alert-row:first-of-type,.cd-news-row:first-of-type{border-top:0}.cd-index{font:800 9px/1 var(--adm-mono);color:var(--muted);min-width:20px}.cd-row-main{min-width:0}.cd-row-main b{display:block;font-size:12px;white-space:nowrap;overflow:hidden;text-overflow:ellipsis}.cd-row-main span{display:block;font-size:10px;color:var(--muted);margin-top:3px;white-space:nowrap;overflow:hidden;text-overflow:ellipsis}.cd-state{font-size:9px;font-weight:850;color:var(--adm-success,#22c55e);white-space:nowrap}.cd-state.warn{color:var(--adm-amber)}.cd-state.bad{color:var(--adm-red)}.cd-grid{display:grid;grid-template-columns:1.15fr .85fr;gap:12px}.cd-service-list{margin-top:13px;display:grid;gap:8px}.cd-service-item{display:flex;justify-content:space-between;gap:10px;font-size:11px}.cd-service-item span:last-child{color:var(--muted);font-size:10px}.cd-empty{padding:14px 0;color:var(--muted);font-size:12px}.cd-quick{display:flex;gap:7px;flex-wrap:wrap;margin-top:14px}.cd-quick a{text-decoration:none;color:var(--muted);border:1px solid var(--line);border-radius:999px;padding:6px 9px;font-size:9px;font-weight:800}.cd-alert-count{font-size:10px;font-weight:900;border:1px solid color-mix(in srgb,var(--adm-amber) 30%,var(--line));color:var(--adm-amber);border-radius:999px;padding:4px 7px}.cd-time{font:700 9px/1 var(--adm-mono);color:var(--muted);white-space:nowrap}
...
export default function AdminDashboard() {
  ...
  return <><style>{CSS}</style><main className="command-dashboard">
    <header className="cd-head">
      <div><div className="cd-eyebrow">{siteName} · central administrativa</div><h1>{siteName}</h1><p>Conteúdo, projetos e operação em uma única leitura.</p></div>
