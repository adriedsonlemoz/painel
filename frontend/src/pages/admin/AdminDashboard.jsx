...
@media(max-width:700px){.cd-head{align-items:flex-start}.cd-head p{max-width:260px}.cd-grid{grid-template-columns:1fr}.cd-feature{grid-template-columns:1fr}.cd-actions{justify-content:flex-start}.cd-pad{padding:16px}.command-dashboard{gap:10px}.cd-project-row,.cd-activity-row,.cd-alert-row,.cd-news-row{gap:8px}}
