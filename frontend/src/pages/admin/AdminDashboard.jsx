...
.cd-head{display:flex;justify-content:space-between;gap:14px;align-items:center;padding:2px 1px 7px}.cd-eyebrow{font:800 9px/1.2 var(--adm-mono);letter-spacing:.14em;color:var(--accent);text-transform:uppercase}.cd-head h1{font-size:clamp(22px,4vw,30px);line-height:1.05;letter-spacing:-.035em;margin:3px 0 3px}.cd-head p{margin:0;color:var(--muted);font-size:12px}.cd-live{display:flex;align-items:center;gap:7px;white-space:nowrap;font-size:10px;font-weight:850;letter-spacing:.08em}.cd-dot{width:7px;height:7px;border-radius:50%;background:var(--adm-success,#22c55e);box-shadow:0 0 0 4px color-mix(in srgb,var(--adm-success,#22c55e) 12%,transparent)}.cd-dot.warn{background:var(--adm-red);box-shadow:0 0 0 4px color-mix(in srgb,var(--adm-red) 12%,transparent)}
