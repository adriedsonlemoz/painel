...
export default function AdminMongo() {
  ...
  return (
    <div className="adm-page mongo-center-page">
      ...
      <style>{`
        .mongo-center-page{display:grid;gap:0}.mongo-config-note{display:grid;grid-template-columns:34px minmax(0,1fr) auto;gap:10px;align-items:center;padding:11px 12px;margin-bottom:14px;border:1px solid color-mix(in srgb,var(--adm-accent) 22%,var(--adm-border));border-radius:12px;background:color-mix(in srgb,var(--adm-accent) 4%,var(--adm-surface));color:var(--adm-text)}.mongo-config-icon{width:32px;height:32px;border-radius:9px;background:color-mix(in srgb,var(--adm-accent) 8%,var(--adm-surface2));color:var(--adm-accent);display:grid;place-items:center}.mongo-config-icon svg{width:16px!important;height:16px!important}.mongo-config-note>div:nth-child(2){display:grid;gap:2px}.mongo-config-note b{font-size:10px}.mongo-config-note span{font-size:8px;line-height:1.45;color:var(--adm-muted)}.mongo-overview{display:grid;gap:11px}.mongo-status-card,.mongo-start-card,.mongo-tools{padding:14px;border:1px solid var(--adm-border);border-radius:14px;background:var(--adm-surface)}.mongo-section-head,.mongo-tools-head{display:flex;justify-content:space-between;gap:12px;align-items:flex-end;margin-bottom:11px}.mongo-section-head small,.mongo-tools-head small{font-size:8px;font-weight:900;letter-spacing:.12em;color:var(--adm-accent)}.mongo-section-head h2,.mongo-tools-head h2{margin:3px 0 0;font-size:16px;color:var(--adm-text)}.mongo-tools-head p{margin:4px 0 0;font-size:9px;color:var(--adm-muted);line-height:1.45}.mongo-status-loading{min-height:90px;display:flex;align-items:center;justify-content:center;gap:8px;color:var(--adm-muted);font-size:10px}.mongo-status-grid{display:grid;grid-template-columns:repeat(6,minmax(0,1fr));gap:7px}.mongo-status-grid>div{display:grid;gap:2px;padding:10px;border:1px solid var(--adm-border);border-radius:10px;background:var(--adm-surface2);min-width:0}.mongo-status-grid b{font-size:12px;color:var(--adm-text);overflow:hidden;text-overflow:ellipsis;white-space:nowrap}.mongo-status-grid small{font-size:7px;color:var(--adm-muted)}.mongo-status-grid .ok b{color:var(--adm-success)}.mongo-status-grid .bad b{color:var(--adm-red)}.mongo-action-grid{display:grid;grid-template-columns:repeat(3,minmax(0,1fr));gap:8px}.mongo-action-grid>button{display:grid;grid-template-columns:28px minmax(0,1fr) auto;gap:8px;align-items:start;text-align:left;padding:12px;border:1px solid var(--adm-border);border-radius:11px;background:var(--adm-surface2);color:var(--adm-text);cursor:pointer;transition:.15s}.mongo-action-grid>button:hover{border-color:color-mix(in srgb,var(--adm-accent) 35%,var(--adm-border));transform:translateY(-1px)}.mongo-action-icon{width:26px;height:26px;border-radius:8px;display:grid;place-items:center;background:color-mix(in srgb,var(--adm-accent) 9%,var(--adm-surface));color:var(--adm-accent);font-size:9px;font-weight:900}.mongo-action-grid button>div{display:grid;gap:4px}.mongo-action-grid b{font-size:10px}.mongo-action-grid small{font-size:8px;line-height:1.45;color:var(--adm-muted)}.mongo-action-grid strong{color:var(--adm-accent);font-size:15px}.mongo-help-strip{display:flex;gap:8px;align-items:flex-start;padding:10px 11px;border:1px dashed var(--adm-border);border-radius:11px;background:var(--adm-surface2)}.mongo-help-strip>div{display:grid;gap:2px}.mongo-help-strip b{font-size:9px}.mongo-help-strip small{font-size:8px;line-height:1.45;color:var(--adm-muted)}.mongo-tool-switch{display:flex;gap:5px;flex-wrap:wrap}.mongo-tool-switch button{padding:7px 9px;border:1px solid var(--adm-border);border-radius:999px;background:var(--adm-surface2);color:var(--adm-muted);font-size:8px;font-weight:800;cursor:pointer}.mongo-tool-switch button.active{background:var(--adm-accent);border-color:var(--adm-accent);color:#fff}
