...
export default function AdminCentral({ area }) {
  ...
  return <div className="adm-hub-page">
    ...
    <style>{`
      ...
      @media(max-width:560px){.adm-hub-head{margin-bottom:13px}.adm-hub-head h1{font-size:19px}.adm-hub-head p{font-size:11px}.adm-hub-grid{grid-template-columns:repeat(2,minmax(0,1fr));gap:7px}.adm-hub-card{grid-template-columns:30px minmax(0,1fr);padding:10px 9px;gap:7px;border-radius:12px}.adm-hub-icon{width:30px;height:30px;border-radius:9px;font-size:13px}.adm-hub-copy b{font-size:10px}.adm-hub-copy small{font-size:7.8px}.adm-hub-arrow{display:none}}
