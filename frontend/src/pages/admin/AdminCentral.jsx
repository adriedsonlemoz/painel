...
const HUBS = {
  ...
  sistema: {
    ...
    desc:'Integrações, usuários, banco, backup e saúde do sistema.',
    items:[
      ...
      ['/admin/sistema','Infraestrutura','Saúde, ambiente, produção e manutenção','▥','sistema.gerenciar'],
