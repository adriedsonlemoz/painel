...
import { confirmAction as confirmPopup } from '../../utils/confirmAction.js'
...
export default function AdminAtualizacoes(){
  ...
  async function interruptCloudRelease(releaseId){
    if(!await confirmPopup('Encerrar somente o acompanhamento desta publicação? O ZIP continuará guardado no R2 e poderá ser publicado novamente.'))return
    try{
  ...
  async function recoverActive(){
    ...
    const ok=await confirmPopup('Interromper a operação ativa e iniciar a recuperação automática pelo snapshot? Use somente quando a atualização estiver travada.')
    if(!ok)return
    try{
  ...
  return <div className="adm-page updates-hub" style={{display:'grid',gap:14}}>
    ...
    <style>{`
      ...
      .updates-hero{display:flex;justify-content:space-between;gap:16px;align-items:flex-start;padding:2px 2px 6px}.updates-kicker{font-size:12px;font-weight:900;letter-spacing:.16em;color:var(--adm-muted);margin-bottom:5px}
      ...
      .updates-release-card{position:relative;border:1px solid var(--adm-border);border-radius:16px;padding:16px;background:linear-gradient(145deg,var(--adm-surface),var(--adm-surface2));box-shadow:0 10px 30px rgba(15,23,42,.04);overflow:hidden}.updates-release-card+.updates-release-card{margin-top:12px}.updates-release-card.latest{border-color:#16a34a55}.updates-release-card.latest:before{content:"";position:absolute;left:0;top:0;bottom:0;width:3px;background:#16a34a}.updates-release-top{display:flex;align-items:center;justify-content:space-between;gap:12px}.updates-release-version{display:flex;gap:10px;align-items:center;min-width:0}.updates-release-version>span{width:38px;height:38px;border-radius:11px;display:grid;place-items:center;background:var(--adm-bg);border:1px solid var(--adm-border);font-size:11px;font-weight:900;color:#16a34a}.updates-release-version>div{display:grid;gap:2px}.updates-release-version small{font-size:11px;letter-spacing:.12em;font-weight:900;color:var(--adm-muted)}.updates-release-version strong{font-size:20px;color:var(--adm-text);letter-spacing:-.03em}.updates-release-ready{font-size:12px;font-weight:900;letter-spacing:.08em;color:#16a34a;border:1px solid #16a34a44;border-radius:999px;padding:5px 7px;background:#16a34a0a}.updates-release-meta{display:flex;gap:6px;flex-wrap:wrap;margin-top:12px}.updates-release-meta span{font-size:12px;font-weight:800;color:var(--adm-muted);border:1px solid var(--adm-border);background:var(--adm-bg);border-radius:999px;padding:5px 7px}.updates-release-file{display:flex;justify-content:space-between;gap:10px;margin-top:10px;font-size:12px;color:var(--adm-muted)}.updates-release-file b{color:var(--adm-text);overflow-wrap:anywhere}.updates-release-file span{flex:0 0 auto}.updates-release-notes{margin-top:14px;border-top:1px solid var(--adm-border);padding-top:13px}.updates-release-notes-head{display:flex;justify-content:space-between;gap:12px;align-items:flex-end}.updates-release-notes-head>div{display:grid;gap:2px}.updates-release-notes-head small{font-size:11px;font-weight:900;letter-spacing:.13em;color:var(--adm-muted)}.updates-release-notes-head b{font-size:13px;color:var(--adm-text)}.updates-release-notes-head>span{font-size:12px;color:var(--adm-muted)}.updates-release-note-list{display:grid;gap:6px;margin-top:9px}.updates-release-note-list>div{display:grid;grid-template-columns:22px minmax(0,1fr);gap:8px;align-items:start;font-size:11px;line-height:1.45}.updates-release-note-list i{font-style:normal;font-family:monospace;color:#16a34a;font-size:12px;padding-top:2px}.updates-release-note-list span{color:var(--adm-muted);overflow-wrap:anywhere}.updates-release-more{margin-top:9px}.updates-release-more summary{cursor:pointer;color:#3b82f6;font-size:12px;font-weight:800}.updates-release-more pre{white-space:pre-wrap;color:var(--adm-text);font-family:inherit;font-size:11px;line-height:1.5;max-width:100%;overflow:auto}.updates-release-health{display:flex;gap:7px;flex-wrap:wrap;margin-top:12px}.updates-release-health span{font-size:12px;color:#16803d;background:#16a34a0a;border-radius:7px;padding:5px 7px}.updates-release-actions{display:flex;justify-content:flex-end;gap:8px;flex-wrap:wrap;margin-top:14px}.updates-release-actions button{border:1px solid var(--adm-border);border-radius:9px;padding:9px 12px;font-weight:850;cursor:pointer}.updates-install-action{background:#16a34a;color:#fff;border-color:#16a34a!important}
      ...
      .updates-code-label{font-size:12px;font-weight:900;letter-spacing:.12em;color:var(--adm-muted);margin:14px 0 6px}.updates-code-block{display:block;padding:11px;border-radius:10px;background:var(--adm-surface2);border:1px solid var(--adm-border);font-size:11px;overflow-wrap:anywhere;color:var(--adm-text)}
      ...
      .updates-wizard-footer{position:sticky;bottom:-20px;z-index:4;margin:16px -20px -20px;padding:12px 20px;background:color-mix(in srgb,var(--adm-surface) 96%,transparent);backdrop-filter:blur(8px);border-top:1px solid var(--adm-border);display:grid;grid-template-columns:auto minmax(0,1fr) auto;gap:10px;align-items:center}.updates-wizard-footer>span{text-align:center;font-size:12px;font-weight:800;color:var(--adm-muted)}.updates-wizard-footer button{border:1px solid var(--adm-border);border-radius:10px;background:var(--adm-surface2);color:var(--adm-text);padding:10px 13px;font-weight:850;cursor:pointer}.updates-primary-action{background:var(--adm-accent)!important;border-color:var(--adm-accent)!important;color:var(--adm-accent-contrast,#fff)!important}.updates-wizard-footer button:disabled{opacity:.5;cursor:not-allowed}
      .updates-progress-stepper{padding:0 20px 4px}.updates-progress-stepper .updates-wizard-steps{margin-bottom:8px}.updates-live-log{margin:12px 0 2px;border:1px solid var(--adm-border);border-radius:12px;background:var(--adm-surface2);overflow:hidden}.updates-live-log-head{display:flex;justify-content:space-between;gap:12px;align-items:flex-start;padding:10px 11px}.updates-live-log-head>div{min-width:0;display:grid;gap:2px}.updates-live-log-head b{font-size:12px;color:var(--adm-text);overflow-wrap:anywhere}.updates-live-log-head>span{font-size:12px;font-weight:850;color:var(--adm-muted);white-space:nowrap}.updates-live-log-track{height:5px;background:var(--adm-surface);overflow:hidden}.updates-live-log-track i{display:block;height:100%;background:var(--adm-accent);transition:width .2s ease}.updates-live-log-current{display:grid;grid-template-columns:auto minmax(0,1fr) auto;gap:7px;align-items:center;padding:8px 10px;border-top:1px solid color-mix(in srgb,var(--adm-border) 65%,transparent)}.updates-live-log-current em{font-style:normal;font-size:11px;font-weight:900;color:var(--adm-accent)}.updates-live-log-current code{min-width:0;font-size:12px;color:var(--adm-muted);overflow:hidden;text-overflow:ellipsis;white-space:nowrap}.updates-live-log-current strong{font-size:12px;color:var(--adm-text);font-variant-numeric:tabular-nums}.updates-live-log-list{max-height:180px;overflow:auto;padding:4px 0}.updates-live-log-list>div{display:grid;grid-template-columns:42px minmax(0,1fr) 16px;gap:7px;align-items:center;padding:5px 10px;border-top:1px solid color-mix(in srgb,var(--adm-border) 65%,transparent);font-size:12px}.updates-live-log-list em{font-style:normal;font-size:11px;font-weight:900;color:var(--adm-accent)}.updates-live-log-list .act-add{color:var(--adm-success)}.updates-live-log-list .act-del{color:var(--adm-danger)}.updates-live-log-list .act-mod{color:var(--adm-warning)}.updates-live-log-list code{font-size:12px;color:var(--adm-muted);overflow-wrap:anywhere;white-space:normal}.updates-live-log-list>div>span{color:var(--adm-success)}.updates-live-log-list .current>span{color:var(--adm-accent)}.updates-cloud-filelog-wrap{margin:0 20px}.updates-failure-report{margin:14px 0 0;border:1px solid color-mix(in srgb,var(--adm-danger) 32%,var(--adm-border));border-radius:14px;background:color-mix(in srgb,var(--adm-danger) 3%,var(--adm-surface));overflow:hidden}.updates-failure-report-head{display:flex;justify-content:space-between;gap:12px;align-items:flex-start;padding:13px 14px;border-bottom:1px solid var(--adm-border)}.updates-failure-report-head>div:first-child{display:grid;gap:3px;min-width:0}.updates-failure-report-head small{font-size:11px;font-weight:900;letter-spacing:.09em;color:var(--adm-danger)}.updates-failure-report-head b{font-size:13px;color:var(--adm-text)}.updates-failure-report-head span{font-size:12px;line-height:1.4;color:var(--adm-muted)}.updates-failure-report-head>div:last-child{display:flex;gap:6px;flex-wrap:wrap;justify-content:flex-end}.updates-failure-report-head button{border:1px solid var(--adm-border);background:var(--adm-surface);color:var(--adm-text);border-radius:8px;padding:7px 9px;font-size:12px;font-weight:800;cursor:pointer}.updates-failure-primary{display:grid;gap:4px;padding:10px 14px;background:color-mix(in srgb,var(--adm-danger) 7%,transparent);border-bottom:1px solid var(--adm-border)}.updates-failure-primary b{font-size:12px;color:var(--adm-danger);text-transform:uppercase;letter-spacing:.06em}.updates-failure-primary span{font-size:12px;line-height:1.45;color:var(--adm-text);overflow-wrap:anywhere}.updates-failure-grid{display:grid;grid-template-columns:repeat(2,minmax(0,1fr));gap:10px;padding:12px}.updates-failure-grid section{min-width:0;border:1px solid var(--adm-border);background:var(--adm-surface);border-radius:11px;padding:10px}.updates-failure-grid section.bad{border-color:color-mix(in srgb,var(--adm-danger) 35%,var(--adm-border))}.updates-failure-grid header{display:flex;align-items:center;gap:7px}.updates-failure-grid header>span{display:grid;place-items:center;width:22px;height:22px;border-radius:7px;background:var(--adm-surface2);font-size:12px;color:var(--adm-muted)}.updates-failure-grid section.bad header>span{color:var(--adm-danger);background:color-mix(in srgb,var(--adm-danger) 8%,var(--adm-surface))}.updates-failure-grid header>div{display:grid;gap:1px}.updates-failure-grid header b{font-size:12px;color:var(--adm-text)}.updates-failure-grid header small{font-size:11px;color:var(--adm-muted)}.updates-failure-grid p{margin:8px 0 0;font-size:12px;line-height:1.45;color:var(--adm-text);overflow-wrap:anywhere}.updates-failure-grid pre{margin:8px 0 0;max-height:190px;overflow:auto;background:var(--adm-bg);border:1px solid var(--adm-border);border-radius:8px;padding:8px;white-space:pre-wrap;overflow-wrap:anywhere;font-size:11px;line-height:1.45;color:var(--adm-muted)}.updates-failure-empty{margin-top:8px;font-size:12px;line-height:1.45;color:var(--adm-muted)}@media(max-width:700px){.updates-failure-report-head{display:grid}.updates-failure-report-head>div:last-child{justify-content:flex-start}.updates-failure-grid{grid-template-columns:1fr}}.updates-modal-overlay{background:var(--adm-overlay,rgba(15,23,42,.46))}
      ...
      .updates-cloud-wizard-done{padding-bottom:0}.updates-cloud-finish-compact{min-height:0;display:grid;grid-template-columns:42px minmax(0,1fr);justify-items:stretch;align-items:center;text-align:left;gap:10px 12px;padding:12px 0}.updates-cloud-finish-compact .updates-cloud-finish-icon{width:42px;height:42px;margin:0;border-radius:13px;font-size:21px}.updates-cloud-finish-copy{min-width:0}.updates-cloud-finish-copy small{display:block;font-size:11px;font-weight:900;letter-spacing:.11em;color:var(--adm-success);margin-bottom:2px}.updates-cloud-finish-compact h3{font-size:16px}.updates-cloud-finish-compact p{font-size:12px;max-width:none}.updates-cloud-finish-compact .updates-cloud-finish-list{grid-column:1/-1;justify-content:flex-start;margin-top:0}
...
function MiniStat({label,value,color}){
 return <div style={{padding:9,borderRadius:9,border:'1px solid var(--adm-border)',background:'var(--adm-bg)',minWidth:0}}>
  <div style={{fontSize:12,color:C.muted,fontWeight:800}}>{label.toUpperCase()}</div>
...
function UpdateProgress({job,embedded=false}){
  ...
  return <section className={embedded?'updates-progress-embedded':''} style={embedded?{borderTop:'1px solid var(--adm-border)',paddingTop:16}:{...card,borderColor:failed?C.red:done?C.greenSolid:C.accent}}>
    ...
    {job.externalProcess&&<div style={{marginTop:14,padding:11,borderRadius:9,background:'var(--adm-surface2)',border:'1px solid var(--adm-border)',fontSize:12}}>
      ...
      {(job.externalProcess.stderrTail||job.externalProcess.stdoutTail)&&<pre style={{margin:'8px 0 0',maxHeight:120,overflow:'auto',whiteSpace:'pre-wrap',fontSize:12,color:C.muted}}>{(job.externalProcess.stderrTail||job.externalProcess.stdoutTail).slice(-2500)}</pre>}
    </div>}
