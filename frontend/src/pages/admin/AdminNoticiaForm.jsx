...
export default function AdminNoticiaForm() {
  ...
  async function restaurarRevisao(revisaoId) {
    if (!confirm('Restaurar esta versão? O estado atual será guardado no histórico antes da restauração.')) return
    try {
  ...
  return (
    <>
      <style>{`
        ...
        .news-details-summary{width:100%;border:0;background:transparent;cursor:pointer;padding:12px 16px;display:flex;justify-content:space-between;align-items:center;gap:10px;color:var(--adm-text);text-align:left}.news-details-summary>span:first-child{display:flex;flex-direction:column;gap:2px}.news-details-summary b{font-size:12px}.news-details-summary small{font-size:10px;font-weight:400;color:var(--adm-muted)}.news-details.open .news-details-summary{border-bottom:1px solid var(--adm-border)}.news-details.open .news-details-summary svg{transform:rotate(180deg)}.news-details-min{display:flex;align-items:center;gap:4px;color:var(--adm-muted);font-size:9px;white-space:nowrap}.news-details-min svg{transition:transform .15s}
        .news-section-strip{display:flex;gap:6px;overflow-x:auto;padding:2px 0 4px;scrollbar-width:none;position:sticky;top:64px;z-index:30;background:var(--adm-bg)}.news-section-strip::-webkit-scrollbar{display:none}.news-section-strip button{border:1px solid var(--adm-border);background:var(--adm-surface);color:var(--adm-muted);border-radius:999px;padding:6px 10px;font-size:10px;font-weight:700;white-space:nowrap;cursor:pointer}.news-section-strip button:hover{color:var(--adm-accent);border-color:var(--adm-accent)}
        .news-ai-actions{display:grid;grid-template-columns:repeat(3,minmax(0,1fr));gap:7px}.news-ai-actions .adm-btn{justify-content:flex-start;min-width:0}.news-ai-tool span{overflow:hidden;text-overflow:ellipsis;white-space:nowrap}.news-ai-result{margin-top:12px;border:1px solid var(--adm-border);border-radius:9px;padding:11px;background:var(--adm-surface2);font-size:11px;line-height:1.5}.news-ai-result-head{display:flex;justify-content:space-between;gap:8px;align-items:center;margin-bottom:8px}.news-ai-result-head small{color:var(--adm-muted)}.news-ai-list{margin:6px 0 0;padding-left:18px}.news-ai-caption{margin-top:10px;font-size:9px;font-weight:800;text-transform:uppercase;letter-spacing:.08em;color:var(--adm-muted)}.news-ai-proposal{padding:8px 0;border-top:1px solid var(--adm-border)}.news-ai-proposal:first-of-type{border-top:0}.news-ai-proposal p{margin:4px 0;white-space:pre-wrap}.news-ai-text{max-height:230px;overflow:auto;padding:9px;border:1px solid var(--adm-border);border-radius:7px;background:var(--adm-surface);white-space:pre-wrap}.news-ai-mini-actions{display:flex;gap:6px;flex-wrap:wrap;margin-top:7px}
        .news-check-list{display:grid;gap:7px;margin-top:8px}.news-check-item{display:grid;grid-template-columns:auto 1fr;gap:8px;padding:8px;border:1px solid var(--adm-border);border-radius:8px;background:var(--adm-surface)}.news-check-item>span{align-self:start;border-radius:999px;padding:2px 6px;font-size:9px;text-transform:uppercase;font-weight:800;background:var(--adm-surface2);color:var(--adm-muted)}.news-check-item.alta>span{color:var(--adm-red)}.news-check-item.media>span{color:#d97706}.news-check-item b{font-size:10px}.news-check-item p{margin:2px 0 0;color:var(--adm-muted);font-size:10px}.news-autosave{display:flex;align-items:center;gap:5px;color:var(--adm-muted);font-size:9px;margin-top:8px}.news-autosave.salvando{color:var(--adm-accent)}.news-autosave.erro{color:var(--adm-red)}.news-seo-preview{display:grid;gap:4px;padding:12px;border:1px solid var(--adm-border);border-radius:9px;background:var(--adm-surface2)}.news-seo-preview small{color:var(--adm-muted)}.news-seo-preview strong{color:#2563eb;font-size:14px;font-weight:600}.news-seo-preview span{color:#15803d;font-size:10px;overflow-wrap:anywhere}.news-seo-preview p{margin:2px 0 0;font-size:11px;line-height:1.45;color:var(--adm-muted)}.news-comment-box{display:grid;grid-template-columns:auto 1fr auto;align-items:start;gap:8px}.news-comment-box>svg{margin-top:10px;color:var(--adm-muted)}.news-comments{display:grid;gap:7px;margin:10px 0}.news-comments>div{padding:8px 10px;border:1px solid var(--adm-border);border-radius:8px;background:var(--adm-surface2)}.news-comments b{font-size:10px}.news-comments small{margin-left:8px;color:var(--adm-muted);font-size:9px}.news-comments p{margin:4px 0 0;font-size:10px;white-space:pre-wrap}.news-history-head{display:flex;align-items:center;justify-content:space-between;gap:10px;margin-top:14px;padding-top:12px;border-top:1px solid var(--adm-border);font-size:10px;font-weight:700}.news-history-head>span:first-child{display:flex;align-items:center;gap:5px}.news-history-list{display:grid;gap:6px;margin-top:8px}.news-history-list>div{display:flex;align-items:center;justify-content:space-between;gap:8px;padding:8px;border:1px solid var(--adm-border);border-radius:8px}.news-history-list b,.news-history-list small{display:block}.news-history-list b{font-size:10px}.news-history-list small{font-size:9px;color:var(--adm-muted);margin-top:2px}
